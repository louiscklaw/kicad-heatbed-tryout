...
def test_get_caution_text():
  result=kicad_template.get_caution_text()
...
def test_get_front_leds():
  result=kicad_template.get_front_leds()
  assert ''!=result, 'get test_get_front_leds failed'

def test_get_hot_warnings():
  result=kicad_template.get_hot_warnings()
...
def test_get_left_territory():
  result=kicad_template.get_left_territory(10, 10)
  assert ''!=result, 'get test_get_left_territory failed'

def test_get_right_territory():
  result=kicad_template.get_right_territory(10, 10)
...
def test_get_this_side_up_text():
  result=kicad_template.get_this_side_up_text()
...
def test_print_boiler_plate():
  result=kicad_template.print_boiler_plate('test boiler plate')
