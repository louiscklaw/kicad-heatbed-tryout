...
def test_check_y_inside_top_left_mount_area():
  result = check_y_inside_top_left_mount_area(5,10,10)
  assert True==result,'get check_y_inside_top_left_mount_area failed'

def test_check_y_inside_top_right_mount_area():
  result = check_y_inside_top_right_mount_area(5,10,10)
  assert True==result,'get check_y_inside_top_right_mount_area failed'
